...
class LeftLegIKGroup(IKGroup):
    
    markerName1 = "IK_Cursor_Left_Knee"
    markerName2 = "IK_Cursor_Left_Foot"
    upperLimbBoneName = "J_Bip_L_UpperLeg"
    lowerLimbBoneName = "J_Bip_L_LowerLeg"
    tipBoneName = "J_Bip_L_Foot"
    poleAngle = 90
