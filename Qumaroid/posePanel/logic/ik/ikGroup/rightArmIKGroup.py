...
class RightArmIKGroup(IKGroup):
    
    markerName0 = "IK_Cursor_Right_Shoulder"
    markerName1 = "IK_Cursor_Right_Elbow"
    markerName2 = "IK_Cursor_Right_Hand"
    rootBoneName = "J_Bip_R_Shoulder"
    upperLimbBoneName = "J_Bip_R_UpperArm"
    lowerLimbBoneName = "J_Bip_R_LowerArm"
    tipBoneName = "J_Bip_R_Hand"
    poleAngle = 0
    ...
    def __init__(self):
        ...
        self.AddIKLimit(armature, self.lowerLimbBoneName, 0,0, 0,0, 0,180)
